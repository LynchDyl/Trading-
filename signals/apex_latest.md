# APEX Ensemble Signal — 2026-09-02 23:30 UTC

Tournament-validated ensemble (out-of-sample: avg week +0.23%, 57% positive weeks, CAGR 11.2%, max DD -24%). Data through **2026-09-02**.

## Components

| Component | Weight | Current stance |
|---|---|---|
| `rotation:aggressive 63/top2` | 20% | BTC 50%, SSO 50% |
