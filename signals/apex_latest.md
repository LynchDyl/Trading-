# APEX Ensemble Signal — 2026-07-17 22:23 UTC

Tournament-validated ensemble (out-of-sample: avg week +0.23%, 57% positive weeks, CAGR 11.2%, max DD -24%). Data through **2026-07-17**.

## Components

| Component | Weight | Current stance |
|---|---|---|
| `rotation:aggressive 63/top2` | 20% | UPRO 50%, TQQQ 50% |
| `swing:ma_cross:SSO` | 20% | **LONG** SSO |
| `rotation:core blend/top3` | 20% | IWM 33%, EEM 33%, QQQ 33% |
