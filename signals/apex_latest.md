# APEX Ensemble Signal — 2026-08-19 21:51 UTC

Tournament-validated ensemble (out-of-sample: avg week +0.23%, 57% positive weeks, CAGR 11.2%, max DD -24%). Data through **2026-08-19**.

## Components

| Component | Weight | Current stance |
|---|---|---|
| `rotation:aggressive 63/top2` | 20% | SSO 50%, UPRO 50% |
| `swing:ma_cross:SSO` | 20% | **LONG** SSO |
| `rotation:core blend/top3` | 20% | IWM 33%, DBC 33%, EEM 33% |
